...
@Component
public class IpPostFilter extends ZuulFilter {
    private Logger logger = LoggerFactory.getLogger(IpPostFilter.class);
    ...
    public Object run() {
        RequestContext ctx = RequestContext.getCurrentContext();
        logger.info("IpPostFilter--------------------------" + System.currentTimeMillis());
        return null;
    }
}
